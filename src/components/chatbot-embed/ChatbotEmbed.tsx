...
const ChatbotEmbed: React.FC<ChatbotEmbedProps> = ({
  ...
  // Focus input when chat opens (skip on mobile to prevent keyboard auto-show)
  useEffect(() => {
  ...
  return (
    <>
      <style>{`
        ...
        .rankved-chatbot .chat-bubble-message {
          text-align: center;
          user-select: none;
        ...
        .rankved-chatbot .message:nth-child(n+2) {
          animation-delay: 0.1s;
        }
        .rankved-chatbot .message:nth-child(n+3) {
          animation-delay: 0.2s;
        }
        .rankved-chatbot .message:nth-child(n+4) {
                ...
                <div
                  style={{
                    ...
                    background: dynamicConfig?.primaryColor
                      ? `linear-gradient(135deg, ${dynamicConfig.primaryColor}, ${dynamicConfig.primaryColor}cc)`
                      : "#6366F1",
                    color: "white",
                    padding: "7px 13px",
                    borderRadius: "16px",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 6px 16px ${
                      dynamicConfig?.primaryColor || "#6366F1"
                    }55`;
                  }}
                  onMouseLeave={(e) => {
